...
type parameter = 
  ...
  | InvestInterestBearingFa12Step2 of invest_interest_bearing_fa12_param
...
let invest_interest_bearing_fa12 (p,s : invest_interest_bearing_fa12_param * Storage.t) : return = 
  ...
  let continue_execution_tr = 
    Tezos.transaction p 0tez (Tezos.self "%investInterestBearingFa12Step2": invest_interest_bearing_fa12_param contract) in
...
let main (param, storage : parameter * Storage.t) : return = match param with
  ...
  | InvestInterestBearingFa12Step2 p -> invest_interest_bearing_fa12_step2 (p,storage)
